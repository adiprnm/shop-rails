...
class AddressServiceTest < ActiveSupport::TestCase
  ...
  test "find_province returns existing province" do
    province = Province.create!(rajaongkir_id: "991", name: "Test Province")
  ...
  test "find_city returns existing city" do
    province = Province.create!(rajaongkir_id: "991", name: "Test Province")
    city = City.create!(rajaongkir_id: "991", name: "Test City", province: province)
  ...
  test "cities_for_province returns cities for given province" do
    province = Province.create!(rajaongkir_id: "991", name: "Test Province")
    city1 = City.create!(rajaongkir_id: "991", name: "City 1", province: province)
    city2 = City.create!(rajaongkir_id: "992", name: "City 2", province: province)
  ...
  test "districts_for_city returns districts for given city" do
    province = Province.create!(rajaongkir_id: "991", name: "Test Province")
    city = City.create!(rajaongkir_id: "991", name: "Test City", province: province)
    district1 = District.create!(rajaongkir_id: "991", name: "District 1", city: city)
    district2 = District.create!(rajaongkir_id: "992", name: "District 2", city: city)
  ...
  test "subdistricts_for_district returns subdistricts for given district" do
    province = Province.create!(rajaongkir_id: "991", name: "Test Province")
    city = City.create!(rajaongkir_id: "991", name: "Test City", province: province)
    district = District.create!(rajaongkir_id: "991", name: "Test District", city: city)
    subdistrict1 = Subdistrict.create!(rajaongkir_id: "991", name: "Subdistrict 1", district: district)
    subdistrict2 = Subdistrict.create!(rajaongkir_id: "992", name: "Subdistrict 2", district: district)
  ...
  test "ensure_provinces returns all provinces when they exist" do
    Province.create!(rajaongkir_id: "991", name: "Province 1")
    Province.create!(rajaongkir_id: "992", name: "Province 2")
  ...
  test "ensure_provinces returns existing provinces" do
    province = Province.create!(rajaongkir_id: "991", name: "Province 1")
  ...
  test "ensure_cities returns cities for given province" do
    province = Province.create!(rajaongkir_id: "991", name: "Test Province")
    City.create!(rajaongkir_id: "991", name: "City 1", province: province)
    City.create!(rajaongkir_id: "992", name: "City 2", province: province)
  ...
  test "ensure_cities returns existing cities for given province" do
    province = Province.create!(rajaongkir_id: "991", name: "Test Province")
    city = City.create!(rajaongkir_id: "991", name: "City 1", province: province)
  ...
  test "ensure_districts returns districts for given city" do
    province = Province.create!(rajaongkir_id: "991", name: "Test Province")
    city = City.create!(rajaongkir_id: "991", name: "Test City", province: province)
    District.create!(rajaongkir_id: "991", name: "District 1", city: city)
    District.create!(rajaongkir_id: "992", name: "District 2", city: city)
  ...
  test "ensure_districts returns existing districts for given city" do
    province = Province.create!(rajaongkir_id: "991", name: "Test Province")
    city = City.create!(rajaongkir_id: "991", name: "Test City", province: province)
    district = District.create!(rajaongkir_id: "991", name: "District 1", city: city)
  ...
  test "ensure_subdistricts returns subdistricts for given district" do
    ...
    city = City.create!(rajaongkir_id: "991", name: "Test City", province: province)
    district = District.create!(rajaongkir_id: "991", name: "Test District", city: city)
    Subdistrict.create!(rajaongkir_id: "991", name: "Subdistrict 1", district: district)
    Subdistrict.create!(rajaongkir_id: "992", name: "Subdistrict 2", district: district)
  ...
  test "ensure_subdistricts returns existing subdistricts for given district" do
    ...
    city = City.create!(rajaongkir_id: "991", name: "Test City", province: province)
    district = District.create!(rajaongkir_id: "991", name: "Test District", city: city)
    subdistrict = Subdistrict.create!(rajaongkir_id: "991", name: "Subdistrict 1", district: district)
